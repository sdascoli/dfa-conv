def add_arguments(parser):
    ...
    parser.add_argument('--n_fc_layers', type=int, default=1, metavar='H',
                        help='number of fc layers for CNN')
    parser.add_argument('--activation', type=str, choices=['linear', 'relu', 'tanh', 'leaky_relu','abs','quadratic','swish'], default='relu', metavar='H',
